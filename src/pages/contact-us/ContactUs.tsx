  ...
  return (
    <article aria-label="Contact Us" className="animate-page">
      ...
      <header className="relative w-full h-[400px] md:h-[500px] overflow-hidden bg-surface flex items-center pt-16 md:pt-24 border-b border-gold/10">
        <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-gold/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[60vw] h-[60vw] bg-primary/5 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4 pointer-events-none" />
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left order-2 md:order-1">
            <ScrollReveal animation="fade-in" delay={0.1}>
              <div className="inline-flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <p className="text-gold tracking-[0.2em] uppercase text-xs md:text-sm font-bold">Get In Touch</p>
              </div>
            </ScrollReveal>
            <ScrollReveal animation="fade-up" delay={0.2}>
              <h1 className="text-primary text-5xl md:text-6xl lg:text-[5rem] font-serif font-bold drop-shadow-sm tracking-wide leading-[1.1] mb-6">
                ...
                <span className="text-gold italic font-medium">Us</span>
              </h1>
            </ScrollReveal>
          </div>
          ...
          <div className="hidden md:flex w-full md:w-1/2 h-full items-center justify-center md:justify-end order-1 md:order-2">
            <ScrollReveal animation="scale-up" delay={0.2}>
              <div className="relative w-48 sm:w-56 md:w-72 lg:w-96 aspect-square">
                ...
                <img
                  src="/assets/gallery/DSC_2981-scaled.jpg"
                ...
                />
                <div className="absolute bottom-6 md:bottom-12 -left-4 md:-left-8 bg-white/95 backdrop-blur-sm p-3 md:p-5 shadow-xl border-l-4 border-gold rounded-r-sm z-20">
                  <p className="text-primary font-serif font-bold text-sm md:text-lg leading-tight">
                    We'd Love <br/> To Hear
                  </p>
                </div>
              </div>
            </ScrollReveal>
